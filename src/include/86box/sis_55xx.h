...
extern void    sis_620_host_to_pci_write(int addr, uint8_t val, void *priv);
extern uint8_t sis_620_host_to_pci_read(int addr, void *priv);
...
extern const device_t sis_620_h2p_device;
